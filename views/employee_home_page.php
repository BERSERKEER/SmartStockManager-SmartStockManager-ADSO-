...
<head>
	...
	<!-- Ruta de estilo -->
	<link rel="stylesheet" href="../public/css/employee_home_style.css">
	<!--Rutas de js-->
	<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
	<script src="../public/js/drop_down_button.js" defer></script>
</head>
<body>
	<?php
    include('../config/connection_db.php');
    $sql = "SELECT * FROM user LIMIT 1"; // Solo obtenemos un usuario
    $result = mysqli_query($conexion, $sql);
    $mostrar = mysqli_fetch_array($result); // Obtiene directamente el primer resultado
    {
    }
    ?>
		...
		<header class="dashboard-header">
			...
			<div class="user-actions">
				<h2>(Empleado)</h2>
				<h1><?php echo isset($mostrar['nombre']) ? htmlspecialchars($mostrar['nombre']) : 'Usuario Desconocido'; ?></h1>
				<img src="https://banner2.cleanpng.com/20190227/zox/kisspng-clip-art-computer-icons-openclipart-user-vector-gr-my-svg-png-icon-free-download-14-352-onlinewe-1713904397626.webp" class="user-pic" onclick="toggleMenu()">
				<div class="sub-menu-wrap" id="subMenu">
					<div class="sub-menu">
						<div class="user-info">
							...
							<h2><?php echo isset($mostrar['nombre']) ? htmlspecialchars($mostrar['nombre']) : 'Usuario Desconocido'; ?></h2>
						</div>
						<hr>
